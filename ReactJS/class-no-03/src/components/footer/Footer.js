...
<div className="container">
  ...
  <div className="wrapper">
    ...
    <a href="#" className="footer-logo">
      <img src={require("../../assets/logo-dark.png")} alt="SimpleBlog Logo" width="150" className="logo-light" />
...
<p className="copyright">
  &copy; Copyright 2024 <a href="#" style={{color: 'hsl(229, 76%, 66%)'}}> SimpleBlog</a>
</p>
